...
for event in range(0,cases['Time_storm'].size):
    ...
    #             ax2.plot(mdates.num2date(tt), UU[:,0], 'b-',label='$\overline{U} + u $ $(Osp1\_A)$',markeredgecolor='k',markersize=8,alpha=0.5)
    #             ax2.plot(mdates.num2date(tt), movingU[:,0], 'r-',label='$\overline{U} $ $(Osp1\_A)$',markeredgecolor='k',markersize=8,alpha=0.5)
    #             ax2     = plt.subplot(312)
    #             locator = mdates.AutoDateLocator(minticks=7, maxticks=9)
    #             formatter = mdates.ConciseDateFormatter(locator)
    #             ax2.xaxis.set_major_locator(locator)
    #             ax2.xaxis.set_major_formatter(formatter)
    #             ax2.plot(mdates.num2date(tt), UU[:,1], 'b-',label='$\overline{U} + u $ $(Osp1\_B)$',markeredgecolor='k',markersize=8,alpha=0.5)
    #             ax2.plot(mdates.num2date(tt), movingU[:,1], 'r-',label='$\overline{U} $ $(Osp1\_B)$',markeredgecolor='k',markersize=8,alpha=0.5)
    #             ax2     = plt.subplot(313)
    #             locator = mdates.AutoDateLocator(minticks=7, maxticks=9)
    #             formatter = mdates.ConciseDateFormatter(locator)
    #             ax2.xaxis.set_major_locator(locator)
    #             ax2.xaxis.set_major_formatter(formatter)
    #             ax2.plot(mdates.num2date(tt), UU[:,2], 'b-',label='$\overline{U} + u $ $(Osp1\_C)$',markeredgecolor='k',markersize=8,alpha=0.5)
    #             ax2.plot(mdates.num2date(tt), movingU[:,2], 'r-',label='$\overline{U} $ $(Osp1\_C)$',markeredgecolor='k',markersize=8,alpha=0.5)            
    # =============================================================================
                #%
...
#                         ax2     = plt.subplot(111)
#         
#                         fre_u_n =  np.linspace(0.01,10,1000)
#                         ax2.loglog(fre_u_n,N400_n_1par(fre_u_n, 6.8),                 'b--',label='$N400$ $ A=6.8$',linewidth=2, markeredgecolor='k',markersize=8)
#                         ax2.loglog(fre_u_n,N400_n_1par(fre_u_n, 9.4),                 'r--',label='$N400$ $ A=9.4$',linewidth=2, markeredgecolor='k',markersize=8)
#                         ax2.loglog(fre_u_n,N400_n_1par(fre_u_n, 20),                 'k--',label='$N400$ $ A=20$',linewidth=2, markeredgecolor='k',markersize=8)
#         
#                         ax2.set_xlim(0.01, 10)               
#                         plt.xlabel(r'$f*L_{ux}/\overline{U}$', fontsize=20)
#                         plt.ylabel(r'$f*S_{fu}$ $/\sigma_{u}^2$', fontsize=20)
...
# 
# 
#                         #% plot the spectra in the raw format
#                         matplotlib.use('Agg')
#                         plt.close("all")
#                         fig     = plt.figure(figsize=(10, 8))
#                         ax2     = plt.subplot(111)
...
#                         ax2.semilogx(f[:,0],N400u_ref(f[:,0], 6.8),                      'b-', label='$N400$ $ A=6.8$',linewidth=2, markeredgecolor='k',markersize=8)
#                         ax2.semilogx(f[:,0],N400u_ref(f[:,0], 9.4),                      'r-', label='$N400$ $ A=9.4$',linewidth=2, markeredgecolor='k',markersize=8)
#                         ax2.semilogx(f[:,0],N400u_ref(f[:,0], 20),                      'k-', label='$N400$ $ A=20$',linewidth=2, markeredgecolor='k',markersize=8)
#         
#                         ax2.set_xlim(0, 10)   
#                         #ax2.set_ylim(0, 400)  
...
# =============================================================================
                        ...
                        Uref       =  meanU[0,i]*(1+np.log(np.asarray(info_osp1.iloc[0,:])[i]/10)/np.log(10/z0))
                        Su_n_froya =  Sfn_from_Sf(f_s,Froya_u(f_s[:,0], Uref, np.asarray(info_osp1.iloc[0,:])[i]).reshape(np.size(f_s),1))
                        plt.close("all")
                        fig     = plt.figure(figsize=(20, 12))
                        ax1     = plt.subplot(321)
                        ...
                        ax1.semilogx(f[:,0],Froya_u(f[:,0], Uref, np.asarray(info_osp1.iloc[0,:])[i]),  'c--',label='$Frøya$ $ ref$',linewidth=2, markeredgecolor='k',markersize=8)           
                        ...
                        plt.xlabel(r'$f$ ($ Hz)$', fontsize=20)
                        plt.ylabel(r'$S_{fu}$ ($m^2 s^{-1})$', fontsize=20)
                        fig.suptitle('Storm No.' + str(event+1)+ ' Dir=' + str(np.round(meanDir[0,i],1)) + '$^o$'+'  Osp1 at height ' + str(np.round(np.asarray(info_osp1.iloc[0,:])[i],1)) + 'm ' \
                        ...
                        path      = 'E:/DATA/Plots/Osp1 Spectra fitting/'
                        save_tite = 'Storm No.' + str(event+1) + '_spectrum fitting Osp1 sensor No.' + str(i+1) + '_'\
                        ...
                        fig.suptitle('Storm No.' + str(event+1) + ' Osp1 at height ' + str(np.round(np.asarray(info_osp1.iloc[0,:])[i],1)) + 'm '\
                                     + 'from '  + date_begin.strftime("%Y-%m-%d %H:%M") + ' to ' + date_stop.strftime("%Y-%m-%d %H:%M"), fontsize=25)
                        plt.rc('xtick', direction='in', color='k')
                        plt.rc('ytick', direction='in', color='k')
                        g1 = plt.grid(b=True, which='major', color='k', linestyle='-', linewidth=0.35)
                        ...
                        path      = 'E:/DATA/Plots/Osp1 Spectra fitting/'
                        save_tite = 'Storm No.' + str(event+1) + '_time series and spectra Osp1 sensor No.' + str(i+1) + '_'\
                                     + str(date_begin.year) + '_' + str(date_begin.month) + '_' + str(date_begin.day)\
