...
Ori   = pd.read_excel('files_svar.xls', sheet_name='Orientation')
...
for i in range(0,monthloop.shape[0]-1):
    ...
    for j in range(ids[0][0],ide[0][0]):     
        ...
        data = pd.read_csv('E:/DATA/svar/' + file_name, skiprows=[0,2,3])
    ...
    data.to_pickle('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '.pkl')

    print(str(year) +'_' + str(mon) +' is finished')

# =============================================================================
#     np.savez_compressed('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_A.npz', A_new)
#     np.savez_compressed('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_B.npz', B_new)
#     np.savez_compressed('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_C.npz', C_new)
#     np.savez_compressed('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_time.npz', time)
#     np.savez_compressed('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_temp_A.npz', temp_A)
# =============================================================================
...
#     gc.collect()    
#     with open('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_A.json', "w") as outfile:
#         json.dump(result['A'], outfile, cls=NumpyEncoder)    
#         
#     with open('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_B.json', "w") as outfile:
#         json.dump(result['B'], outfile, cls=NumpyEncoder)    
#     
#     with open('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_C.json', "w") as outfile:
#         json.dump(result['C'], outfile, cls=NumpyEncoder)    
#     
#     with open('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_time.json', "w") as outfile:
#         json.dump(result['time'], outfile, cls=NumpyEncoder)    
# 
#     with open('E:/DATA/svar/' +'Svar_'+ str(year) +'_' + str(mon)+ '_temp_A.json', "w") as outfile:
