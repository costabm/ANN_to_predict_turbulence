...
# =============================================================================
                    ...
                    Cuy[flag_case,0],  pcov = curve_fit(Coh_lateral_dy,f_s[indfu_s[0]:indfu_e[0],0], Coh_u_s[indfu_s[0]:indfu_e[0],0],p0=(0.5),maxfev=100000)
                    Cvy[flag_case,0],  pcov = curve_fit(Coh_lateral_dy,f_s[indfu_s[0]:indfu_e[0],0], Coh_v_s[indfu_s[0]:indfu_e[0],0],p0=(0.5),maxfev=100000)
                    Cwy[flag_case,0],  pcov = curve_fit(Coh_lateral_dy,f_s[indfu_s[0]:indfu_e[0],0], Coh_w_s[indfu_s[0]:indfu_e[0],0],p0=(0.5),maxfev=100000)
