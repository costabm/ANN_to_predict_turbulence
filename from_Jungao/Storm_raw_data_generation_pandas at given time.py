...
for i in range(0,cases['Time_storm'].size):
    ...
    #Osp1    
    if os.path.isfile('E:/DATA/osp1/' +'Osp1_'+ year_s +'_' + mon_s+ '.pkl')\
        and os.path.isfile('E:/DATA/osp1/' +'Osp1_'+ year_e +'_' + mon_e+ '.pkl'): 
        # if it is same month, just load data once, otherwise, need to append two months' data         
        # load raw sensor data
        if mon_s==mon_e:            
            data = pd.read_pickle('E:/DATA/osp1/' +'Osp1_'+ year_s +'_' + mon_s+ '.pkl')                       
        else:
            data = pd.read_pickle('E:/DATA/osp1/' +'Osp1_'+ year_s +'_' + mon_s+ '.pkl')
            temp = pd.read_pickle('E:/DATA/osp1/' +'Osp1_'+ year_e +'_' + mon_e+ '.pkl')
    ...
    #Osp2    
    if os.path.isfile('E:/DATA/osp2/' +'Osp2_'+ year_s +'_' + mon_s+ '.pkl')\
        and os.path.isfile('E:/DATA/osp2/' +'Osp2_'+ year_e +'_' + mon_e+ '.pkl'): 
        # if it is same month, just load data once, otherwise, need to append two months' data         
        # load raw sensor data
        if mon_s==mon_e:            
            data = pd.read_pickle('E:/DATA/osp2/' +'Osp2_'+ year_s +'_' + mon_s+ '.pkl')                       
        else:
            data = pd.read_pickle('E:/DATA/osp2/' +'Osp2_'+ year_s +'_' + mon_s+ '.pkl')
            temp = pd.read_pickle('E:/DATA/osp2/' +'Osp2_'+ year_e +'_' + mon_e+ '.pkl')
            data = data.append(temp,ignore_index=True)          
        ...
        if len( data[data.Time==time_S].index.values.astype(int))>0:
            idx_S = data[data.Time==time_S].index.values.astype(int)[0]
            idx_E = data[data.Time==time_E].index.values.astype(int)[0]
    ...
    #Svar    
    if os.path.isfile('E:/DATA/svar/' +'Svar_'+ year_s +'_' + mon_s+ '.pkl')\
        and os.path.isfile('E:/DATA/svar/' +'Svar_'+ year_e +'_' + mon_e+ '.pkl'): 
        # if it is same month, just load data once, otherwise, need to append two months' data         
        # load raw sensor data
        if mon_s==mon_e:            
            data = pd.read_pickle('E:/DATA/svar/' +'Svar_'+ year_s +'_' + mon_s+ '.pkl')                       
        else:
            data = pd.read_pickle('E:/DATA/svar/' +'Svar_'+ year_s +'_' + mon_s+ '.pkl')
            temp = pd.read_pickle('E:/DATA/svar/' +'Svar_'+ year_e +'_' + mon_e+ '.pkl')
            data = data.append(temp,ignore_index=True)          
    ...
    #Synn    
    if os.path.isfile('E:/DATA/synn/' +'Synn_'+ year_s +'_' + mon_s+ '.pkl')\
        and os.path.isfile('E:/DATA/synn/' +'Synn_'+ year_e +'_' + mon_e+ '.pkl'): 
        # if it is same month, just load data once, otherwise, need to append two months' data         
        # load raw sensor data
        if mon_s==mon_e:            
            data = pd.read_pickle('E:/DATA/synn/' +'Synn_'+ year_s +'_' + mon_s+ '.pkl')                       
        else:
            data = pd.read_pickle('E:/DATA/synn/' +'Synn_'+ year_s +'_' + mon_s+ '.pkl')
            temp = pd.read_pickle('E:/DATA/synn/' +'Synn_'+ year_e +'_' + mon_e+ '.pkl')
            data = data.append(temp,ignore_index=True)          
