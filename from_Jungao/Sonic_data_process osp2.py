...
for i in range(0,monthloop.shape[0]-1):
    ...
    A  =  np.load('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_A.npz')['arr_0']   
    B  =  np.load('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_B.npz')['arr_0']    
    C  =  np.load('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_C.npz')['arr_0']    
    time  =  np.load('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_time.npz')['arr_0']  
    ...
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_A_time_1h.npz', time_ref)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_A_dir_1h.npz', A_dir)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_A_U_1h.npz', A_U)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_A_uvw_1h.npz', A_uvw)
    
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_B_dir_1h.npz', B_dir)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_B_U_1h.npz', B_U)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_B_uvw_1h.npz', B_uvw)

    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_C_dir_1h.npz', C_dir)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_C_U_1h.npz', C_U)
    np.savez_compressed('D:/DATA/osp2/' +'Osp2_'+ str(year) +'_' + str(mon)+ '_C_uvw_1h.npz', C_uvw)
