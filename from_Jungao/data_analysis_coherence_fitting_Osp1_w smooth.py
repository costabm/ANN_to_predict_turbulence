...
# =============================================================================
                    ...
                    [Cux[flag_case,0],Cuy[flag_case,0]],  pcov = curve_fit(Coh_lateral,f_s[indfu_s[0]:indfu_e[0],0], Coh_u_s[indfu_s[0]:indfu_e[0],0],p0=(0.5,6),bounds=(0, [10, 20]),maxfev=100000)
                    [Cvx[flag_case,0],Cvy[flag_case,0]],  pcov = curve_fit(Coh_lateral,f_s[indfu_s[0]:indfu_e[0],0], Coh_v_s[indfu_s[0]:indfu_e[0],0],p0=(0.5,6),bounds=(0, [10, 20]),maxfev=100000)
                    [Cwx[flag_case,0],Cwy[flag_case,0]],  pcov = curve_fit(Coh_lateral,f_s[indfu_s[0]:indfu_e[0],0], Coh_w_s[indfu_s[0]:indfu_e[0],0],p0=(0.5,6),bounds=(0, [10, 20]),maxfev=100000)
